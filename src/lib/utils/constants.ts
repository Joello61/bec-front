...
export const ROUTES = {
  ...
  SEARCH_VOYAGES: '/search/voyages' as Route,
  SEARCH_DEMANDES: '/search/demandes' as Route,
  SEARCH_VOYAGE_DETAILS: (id: number) => `/search/voyages/${id}` as Route,
  SEARCH_DEMANDE_DETAILS: (id: number) => `/search/demandes/${id}` as Route,
