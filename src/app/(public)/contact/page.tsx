...
export const metadata: Metadata = {
  ...
  description:
    "Une question sur Co-Bage ? Contactez notre équipe support disponible 24/7. Obtenez de l'aide pour vos voyages, envois de colis ou tout problème technique entre le Cameroun et l'Afrique.",
  keywords: [
    'contact Co-Bage',
    'support Co-Bage',
  ...
  openGraph: {
    ...
    description:
      'Notre équipe est disponible 24/7 pour répondre à vos questions sur le transport collaboratif de colis.',
    type: 'website',
    url: '/contact',
    images: [
      {
...
const contactPageSchema = {
  ...
  description:
    'Page de contact pour Co-Bage, plateforme de transport collaboratif de colis',
