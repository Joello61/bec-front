...
export default function PublicVoyageCard({ voyage }: PublicVoyageCardProps) {
  ...
  return (
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="text-right">
                  <div className="flex items-center gap-2 group relative">
                    <DollarSign className="w-4.5 h-4.5 text-gray-600 flex-shrink-0" />
                    <span className='text-sm'>
                      <span className='font-bold text-primary'>
                        {voyage.prixParKilo} {voyage.currency}  
                      </span>
    ...
    <AuthRequiredModal
      ...
      message="Pour consulter les détails de ce voyage, vous devez être connecté(e)"
    />
    </>
  );
}